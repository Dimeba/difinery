 ...
 *
 * Use this instead of `new URL(path, request.url)` for redirects: on Netlify
 * request.url carries the internal deploy host, not difinery.com.
 */
export function siteUrl(path = '/') {
	return new URL(path, CA.siteUrl)
}
